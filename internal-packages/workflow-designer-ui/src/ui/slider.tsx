...
function SliderInner({
	...
	return (
		...
		>
			...
			<SliderPrimitive.Thumb className="block h-[10px] w-[10px] rounded-full bg-white-900 transition-transform hover:scale-110 focus:outline-none focus:ring-0 active:outline-none active:ring-0" />
		</SliderPrimitive.Root>
	);
}
