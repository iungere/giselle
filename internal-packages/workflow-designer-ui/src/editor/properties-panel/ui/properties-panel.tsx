...
export function PropertiesPanelRoot({ children }: { children: ReactNode }) {
  return (
    <div className="h-full w-full flex flex-col gap-[8px] overflow-hidden pb-[16px]">
      {children}
    </div>
  );
}
...
export function PropertiesPanelHeader({
  ...
  if (sidemenu) {
    return (
      <div className="h-[48px] flex justify-between items-center pr-[16px] pt-[16px] pb-[16px] shrink-0">
