...
export function DialogTitle({ children }: PropsWithChildren) {
	return (
		<DialogPrimitive.Title className="text-[20px] font-medium text-white-400 tracking-tight font-sans">
			{children}
...
export function DialogDescription({ children }: PropsWithChildren) {
	return (
		<DialogPrimitive.Description className="text-[14px] text-black-400 font-geist mt-2">
			{children}
